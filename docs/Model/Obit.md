...
**metadata** | [**\Obada\ClientHelper\MetaDataRecord[]**](MetaDataRecord.md) | Get description from Rohi | [optional]
...
**structuredData** | [**\Obada\ClientHelper\StructureDataRecord[]**](StructureDataRecord.md) | Same as metadata but bigger. Key (string) &#x3D;&gt; Value (string) (hash per line sha256(key + value)) | [optional]
