...
class ObitApi
{
            ...
            switch($statusCode) {
                case 200:
                    if ('\Obada\ClientHelper\ClientObitResponse' === '\SplFileObject') {
                        ...
                        if ('\Obada\ClientHelper\ClientObitResponse' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Obada\ClientHelper\BlockChainObitResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Obada\ClientHelper\BlockChainObitResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Obada\ClientHelper\ObitDefinitionResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Obada\ClientHelper\ObitDefinitionResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @throws \Obada\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Obada\ClientHelper\RootHashResponse
     */
     ...
     * @throws \Obada\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Obada\ClientHelper\RootHashResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateRootHashWithHttpInfo($localObit = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Obada\ClientHelper\RootHashResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Obada\ClientHelper\RootHashResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Obada\ClientHelper\RootHashResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Obada\ClientHelper\RootHashResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Obada\ClientHelper\RootHashResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
            ...
            switch($statusCode) {
                case 200:
                    if ('\Obada\ClientHelper\BaseResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Obada\ClientHelper\BaseResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
