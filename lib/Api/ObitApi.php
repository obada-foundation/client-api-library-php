...
class ObitApi
{
     ...
     * @return \Obada\ClientHelper\Checksum|\Obada\ClientHelper\UnprocessableEntity|\Obada\ClientHelper\InternalServerError
     */
     ...
     * @throws \Obada\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Obada\ClientHelper\Checksum|\Obada\ClientHelper\UnprocessableEntity|\Obada\ClientHelper\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function checksumWithHttpInfo($obit = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Obada\ClientHelper\Checksum' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Obada\ClientHelper\Checksum' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Obada\ClientHelper\Checksum', []),
            ...
            $returnType = '\Obada\ClientHelper\Checksum';
     ...
     * @throws \Obada\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Obada\ClientHelper\GenerateObitDID|\Obada\ClientHelper\UnprocessableEntity|\Obada\ClientHelper\InternalServerError
     */
     ...
     * @throws \Obada\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Obada\ClientHelper\GenerateObitDID|\Obada\ClientHelper\UnprocessableEntity|\Obada\ClientHelper\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateDIDWithHttpInfo($generateObitDIDRequest = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Obada\ClientHelper\GenerateObitDID' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Obada\ClientHelper\GenerateObitDID' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Obada\ClientHelper\GenerateObitDID', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\Obada\ClientHelper\GenerateObitDID';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Obada\ClientHelper\GenerateObitDID',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Obada\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Obada\ClientHelper\InlineResponse200|\Obada\ClientHelper\NotFound
     */
     ...
     * @throws \Obada\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Obada\ClientHelper\InlineResponse200|\Obada\ClientHelper\NotFound, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    if ('\Obada\ClientHelper\InlineResponse200' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Obada\ClientHelper\InlineResponse200' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
