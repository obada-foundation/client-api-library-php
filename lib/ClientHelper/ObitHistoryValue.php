...
class ObitHistoryValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('versionHash', $data ?? [], null);
        $this->setIfExists('rootHash', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($versionHash)) {
            throw new \InvalidArgumentException('non-nullable versionHash cannot be null');
        }
    ...
    {
        if (is_null($rootHash)) {
            throw new \InvalidArgumentException('non-nullable rootHash cannot be null');
        }
