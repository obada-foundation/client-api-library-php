...
/**
 * BatchSendNFTRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BatchSendNFTRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchSendNFTRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('nfts', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['nfts'];
    }

    /**
     * Sets nfts
     *
     * @param string[]|null $nfts nfts
     *
     * @return self
     */
    ...
    {
        if (is_null($nfts)) {
            throw new \InvalidArgumentException('non-nullable nfts cannot be null');
        }
        $this->container['nfts'] = $nfts;
