...
/**
 * ExportAccountRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ExportAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExportAccountRequest';
     ...
     * Sets passphrase
     *
     * @param string|null $passphrase Passphrase to decrypt the account
     *
     * @return self
     */
