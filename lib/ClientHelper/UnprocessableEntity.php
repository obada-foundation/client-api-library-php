...
class UnprocessableEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error' => 'string',
        'fields' => '\Obada\ClientHelper\UnprocessableEntityFieldsInner[]'
    ];
    ...
    {
        $this->setIfExists('error', $data ?? [], 'data validation error');
    ...
    */
     ...
     * Gets fields
     *
     * @return \Obada\ClientHelper\UnprocessableEntityFieldsInner[]|null
     */
     ...
     * Sets fields
     *
     * @param \Obada\ClientHelper\UnprocessableEntityFieldsInner[]|null $fields fields
     *
     * @return self
     */
