...
class LocalObit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'partNumber' => 'string',
        'serialNumber' => 'string',
        'metadata' => '\Obada\ClientHelper\LocalObitMetadataInner[]',
        'documents' => '\Obada\ClientHelper\LocalObitDocumentsInner[]',
        'structuredData' => '\Obada\ClientHelper\LocalObitStructuredDataInner[]',
        'modifiedAt' => '\DateTime'
    ];
     ...
     * Gets metadata
     *
     * @return \Obada\ClientHelper\LocalObitMetadataInner[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Obada\ClientHelper\LocalObitMetadataInner[]|null $metadata Get description from Rohi
     *
     * @return self
     */
     ...
     * Gets documents
     *
     * @return \Obada\ClientHelper\LocalObitDocumentsInner[]|null
     */
     ...
     * Sets documents
     *
     * @param \Obada\ClientHelper\LocalObitDocumentsInner[]|null $documents To generate this link, take an SHA-256 hash of the document, and link to it as https://www.some-website.com?h1=hash-of-document. Note this does not yet adhere to the hashlink standard.
     *
     * @return self
     */
     ...
     * Gets structuredData
     *
     * @return \Obada\ClientHelper\LocalObitStructuredDataInner[]|null
     */
     ...
     * Sets structuredData
     *
     * @param \Obada\ClientHelper\LocalObitStructuredDataInner[]|null $structuredData Same as metadata but bigger. Key (string) => Value (string) (hash per line sha256(key + value))
     *
     * @return self
     */
