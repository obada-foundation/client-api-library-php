...
class Accounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('hdAccounts', $data ?? [], null);
        $this->setIfExists('importedAccounts', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($hdAccounts)) {
            throw new \InvalidArgumentException('non-nullable hdAccounts cannot be null');
        }
    ...
    {
        if (is_null($importedAccounts)) {
            throw new \InvalidArgumentException('non-nullable importedAccounts cannot be null');
        }
