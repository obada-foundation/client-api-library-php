 ...
 */
class ObitDid implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObitDid';
    ...
    public function setObitDid($obitDid)
    {
        if ((mb_strlen($obitDid) > 256)) {
            throw new \InvalidArgumentException('invalid length for $obitDid when calling ObitDid., must be smaller than or equal to 256.');
        }
