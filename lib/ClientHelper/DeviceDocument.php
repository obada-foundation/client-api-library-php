...
/**
 * DeviceDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class DeviceDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceDocument';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('documentFile', $data ?? [], null);
        $this->setIfExists('shouldEncrypt', $data ?? [], false);
    }
    ...
    */
    ...
    public function setDocumentFile($documentFile)
    {
        if (is_null($documentFile)) {
            throw new \InvalidArgumentException('non-nullable documentFile cannot be null');
        }
    ...
    {
        if (is_null($shouldEncrypt)) {
            throw new \InvalidArgumentException('non-nullable shouldEncrypt cannot be null');
        }
