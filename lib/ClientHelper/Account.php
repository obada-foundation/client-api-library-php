...
class Account implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pubKey', $data ?? [], null);
        $this->setIfExists('address', $data ?? [], null);
        $this->setIfExists('balance', $data ?? [], null);
        $this->setIfExists('nftCount', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($pubKey)) {
            throw new \InvalidArgumentException('non-nullable pubKey cannot be null');
        }
    ...
    {
        if (is_null($nftCount)) {
            throw new \InvalidArgumentException('non-nullable nftCount cannot be null');
        }
