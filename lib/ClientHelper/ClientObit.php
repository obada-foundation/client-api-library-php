...
class ClientObit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'modifiedAt' => '\DateTime',
        'rootHash' => 'string',
        'metadata' => '\Obada\ClientHelper\ClientObitMetadata[]',
        'documents' => '\Obada\ClientHelper\ClientObitDocuments[]',
        'structuredData' => '\Obada\ClientHelper\ClientObitStructuredData[]'
    ];
     ...
     * Gets metadata
     *
     * @return \Obada\ClientHelper\ClientObitMetadata[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Obada\ClientHelper\ClientObitMetadata[]|null $metadata Get description from Rohi
     *
     * @return self
     */
     ...
     * Gets documents
     *
     * @return \Obada\ClientHelper\ClientObitDocuments[]|null
     */
     ...
     * Sets documents
     *
     * @param \Obada\ClientHelper\ClientObitDocuments[]|null $documents To generate this link, take an SHA-256 hash of the document, and link to it as https://www.some-website.com?h1=hash-of-document. Note this does not yet adhere to the hashlink standard.
     *
     * @return self
     */
     ...
     * Gets structuredData
     *
     * @return \Obada\ClientHelper\ClientObitStructuredData[]|null
     */
     ...
     * Sets structuredData
     *
     * @param \Obada\ClientHelper\ClientObitStructuredData[]|null $structuredData Same as metadata but bigger. Key (string) => Value (string) (hash per line sha256(key + value))
     *
     * @return self
     */
