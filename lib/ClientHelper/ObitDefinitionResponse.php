...
/**
 * ObitDefinitionResponse Class Doc Comment
 *
 * @category Class
 * @package  Obada
 * @author   OpenAPI Generator team
 ...
 */
class ObitDefinitionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObitDefinitionResponse';
    ...
    protected static $openAPITypes = [
        'status' => 'int',
        'obit' => '\Obada\ClientHelper\ObitDefinition'
    ];
     ...
     * Sets obit
     *
     * @param \Obada\ClientHelper\ObitDefinition|null $obit obit
     *
     * @return self
     */
